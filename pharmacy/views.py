...
def update_prescription(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, _('An error occurred while attempting to update prescription.'))
    context = {
        'form': form,
...
def update_drug(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, _('An error occurred while attempting to update drug.'))
    context = {
        'form': form,
        'drug': drug,
    }
...
def prescriptions_doctor(request):
    ...
    return render(request, 'pharmacy/doctor_prescriptions_panel.html', context=context)
...
def delete_prescription(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('drugs_path')
    return render(request, 'pharmacy/delete_prescription.html', {'prescription': prescription})
