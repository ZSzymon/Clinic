...
urlpatterns = [
    ...
    path(
        "notebook/update_note/<str:pk>",
        account_view.update_note,
        name="account-update_note",
    ),
    path(
        "notebook/delete_note/<str:pk>",
        account_view.delete_note,
        name="account-delete_note",
    ),
]
